        ...
        {showPreview && resumeId > 0 && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 right-0 z-50 h-full w-[min(720px,90vw)]
            ...
            >
              ...
              {/* 抽屉底部：工具 + 保存操作条 */}
              <div className="shrink-0 border-t border-[var(--color-border)] px-4 py-3 flex items-center justify-between gap-2 flex-wrap">
